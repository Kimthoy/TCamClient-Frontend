...
import EmptyCareerPage from "./empty/EmptyCareer";
        ...
        {!loading && !error && jobs.length > 0 && (
          <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
            {jobs.map((job, i) => (
              <motion.div
                key={job.id}
                className="relative flex flex-col justify-between p-6 rounded-2xl bg-white
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <button
                      ...
                      className="mt-4 w-36 flex items-center justify-center gap-2
                         bg-emerald-600 text-white py-2 rounded-full text-sm
                         hover:bg-emerald-700 group"
                    >
                      View Details
